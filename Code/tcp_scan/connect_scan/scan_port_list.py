    ...
    for port in ports:
        ...
        try:
            with closing(socket.socket(socket.AF_INET, socket.SOCK_STREAM)) as s:
                ...
                # attempt to connect the newly created socket to the target address and port
                open_ports.append(port)
                # if the connection was successful then add the port to the list of open ports
