...
\begin{figure}[H]
  ...
  \begin{framed}
    \begin{tikzpicture}[node distance=2cm]
      ...
      \node [io, below of=start, text width=3cm] (input) {get list of addresses to scan};
      ...
      \draw [arrow] (loop) -- node[midway,above] {yes} (get);
      \draw [arrow] (send) -| node[midway,above,xshift=2cm] {yes} (loop);
