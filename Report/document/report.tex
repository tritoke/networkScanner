...
\begin{figure}[H]
  ...
  \begin{framed}
    \begin{tikzpicture}[node distance=1.5cm]
      ...
      \draw [arrow] (loop 1.east) -- ([xshift=1cm]loop 1.east);
      \draw [arrow] ([xshift=1cm]loop 1.east) -- ([xshift=1cm,yshift=0.75cm]send 1.east) node [right,yshift=-1.25cm] {yes} -| (send 1.north);
      \draw [arrow] (loop 1) -| node [above, xshift=1cm] {no} (loop 2);
      \draw [arrow] (loop 2.west) -- ([xshift=-0.5cm]loop 2.west);
      \draw [arrow] ([xshift=-0.5cm]loop 2.west) -- ([xshift=-4cm,yshift=0.75cm]send 1.west) node [left,yshift=-2cm] {no} -| (send 1.north);
...
\begin{figure}[H]
  ...
  \begin{framed}
    \begin{tikzpicture}[node distance=1.5cm]
      ...
      \draw [arrow] (softmatch loop.west) -- ([xshift=-0.4cm]softmatch loop.west);
      ...
      \draw [arrow] (match loop) -- ([xshift=0.375cm]match loop.east);
      ...
      \draw [arrow] (probe loop.west) -- ([xshift=-1.125cm]probe loop.west);
